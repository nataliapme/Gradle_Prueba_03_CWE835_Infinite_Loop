...
/* BEGIN-AUTOGENERATED-JAVA-TESTS-8 */
			(new CWE835_Infinite_Loop__while_true_01()).runTest("CWE835_Infinite_Loop__while_true_01");
			(new CWE835_Infinite_Loop__for_01()).runTest("CWE835_Infinite_Loop__for_01");
			(new CWE835_Infinite_Loop__for_empty_01()).runTest("CWE835_Infinite_Loop__for_empty_01");
			(new CWE835_Infinite_Loop__do_true_01()).runTest("CWE835_Infinite_Loop__do_true_01");
			(new CWE835_Infinite_Loop__while_01()).runTest("CWE835_Infinite_Loop__while_01");
			(new CWE835_Infinite_Loop__do_01()).runTest("CWE835_Infinite_Loop__do_01");
